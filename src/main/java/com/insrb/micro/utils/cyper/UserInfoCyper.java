...
//     * @throws Exception
//     */
//    public static String EncryptMobile(String data) throws Exception {
...
//
//
//    public static String DecryptMobile(String data) throws Exception {
//        Key key = TripleDESUtil.createKey(SALT);
...
//     * @throws Exception
//     */
//    public static String EncryptJuminb(String juminB) throws Exception {
//        Key key = TripleDESUtil.createKey(SALT);
...
//            throw new Exception("NoSuchAlgorithmException 암호화 알고리즘 예외발생");
//        }
//        return  Base64.getEncoder().encodeToString(txt);
//    }
//
//    /**
//     * for windwaterFree form.
//     * 전화번호 / (주민번호 뒷 6자리)는 양방향 암호화를 한다. 암호화 방식은 Triple DES, Rainbow Attack 을 피하기 위해 키 생성시
//     * salt를 사용하는데, xml 파일 내용과 "insurobo" 를 합쳐 sha256으로 Hasing하고 그 결과 중 24 bytes를 키 값으로 사용. 이 키를
//     * 사용하여 암.복호화한다.
//     *
//     * @param data
...
//     * @throws Exception
//     */
//    public static String EncryptInfo(String data) throws Exception {
//        Key key = TripleDESUtil.createKey(SALT);
//        String enc = TripleDESUtil.encrypt(key, data);
//        return enc;
//    }
//    public static String DecryptInfo(String data) throws Exception {
//        Key key = TripleDESUtil.createKey(SALT);
//        String dec = TripleDESUtil.decrypt(key, data);
//        return dec;
//    }
