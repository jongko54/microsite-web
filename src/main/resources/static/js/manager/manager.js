$(document).ready(function () {
    var table = $('#manager_table1').DataTable({
            //scrollY:500,
            "language": {
                "emptyTable": "데이터가 없어요.",
    ...
    //allcheck
    $('#manager_table1 tbody').on('click', 'tr td:first-child', function() {
...
const handleDelete = () => {
    //체크 된 로우의 id값을 가져옴
    let row_data = $.map($('#manager_table1').DataTable().rows('.selected').data(), function(item){
        return item.id;
    });
